-- =====================================================================
-- FacturacionHSM · Migración 0001 · ESQUEMA (tablas, constraints, índices)
-- Base de datos NUEVA. NO hay datos previos que migrar. Inicia desde cero.
-- PostgreSQL / Supabase
-- =====================================================================
...
-- =====================================================================
-- 1. TENANTS Y USUARIOS (multi-tenant SaaS Kubit)
-- =====================================================================
...
create table public.usuarios (
  ...
  vendedor_id uuid,  -- FK lógica a vendedores (se asigna luego; evita ciclo de creación)
...
-- =====================================================================
-- 2. CATÁLOGOS PARAMETRIZABLES (por tenant)
-- =====================================================================

-- 2.1 Estados / etapas del proceso (CRUDO, EN_PRODUCCION, TERMINADO, LISTO)
...
-- 2.2 Calidades / condición (PRIMERA, SEGUNDA, MERMA)
...
-- 2.6 Procesos de producción (ESTAMPACION, BORDADO, APLIQUE, EMPAQUE)
...
create table public.ubicaciones (
  ...
  nombre      text not null,
  vendedor_id uuid,  -- FK lógica a vendedores (para tipo VENDEDOR)
  activo      boolean not null default true
);
...
-- Precio por calidad (segunda calidad puede tener precio distinto)
...
-- =====================================================================
-- 5. PROVEEDORES, COMPRAS Y RECEPCIÓN (recibos parciales)
-- =====================================================================
...
-- 6.1 SALDO: proyección por variante x ubicacion x estado x calidad
...
-- 6.2 LIBRO MAYOR: eventos inmutables (append-only)
create table public.movimientos_inventario (
  ...
  doc_tipo             text not null,   -- COMPRA, PRODUCCION, TRANSFERENCIA, VENTA, AJUSTE
...
-- Entradas (qué se metió a producir)
...
-- Resultados (cómo quedó, por calidad)
...
create table public.vendedores (
  ...
  telefono    text,
  municipio   text,
  ubicacion_id uuid references public.ubicaciones(id),  -- ubicacion tipo VENDEDOR
  activo      boolean not null default true
);
...
-- =====================================================================
-- 11. FKs lógicas diferidas (evitan ciclos de creación)
-- =====================================================================
