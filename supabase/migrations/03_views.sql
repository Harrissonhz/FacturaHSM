-- =====================================================================
-- FacturacionHSM · SCRIPT 03 · VISTAS de reportes / trazabilidad
...
select cxc.tenant_id, cxc.id as cuenta_id, cxc.cliente_id, cl.nombre as cliente, ven.nombre as vendedor,
